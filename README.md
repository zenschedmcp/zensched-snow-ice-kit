...
| Clear Proof not on the phone | Form not assigned to that site's event before the shift was created | "Attach the Clear Proof to Maple" (`form_assign`), then cancel and recreate the shift |
